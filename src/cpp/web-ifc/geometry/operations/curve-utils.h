...
inline IfcCurve Build3DArc3Pt(const glm::dvec3 &p1, const glm::dvec3 &p2, const glm::dvec3 &p3, uint16_t circleSegments, double EPS_MINSIZE)
{
	...
	inline IfcCurve GetIShapedCurve(double width, double depth, double webThickness, double flangeThickness, bool hasFillet, double filletRadius, glm::dmat3 placement = glm::dmat3(1), double flangeEdgeRadius = 0, int numSegments = 8)
	{
		glm::dmat4 placement4 = glm::dmat4(
			glm::dvec4(placement[0], 0.0),  // First column + w=0
			glm::dvec4(placement[1], 0.0),  // Second column + w=0  
		...
		bimGeometry::Curve temp = bimGeometry::GetIShapedCurve(width, depth, webThickness, flangeThickness, hasFillet, filletRadius, placement4, flangeEdgeRadius, numSegments);
		IfcCurve c;
		c.points = temp.points;
		return c;
	}

	inline IfcCurve GetAsymmetricIShapedCurve(double topWidth, double bottomWidth, double depth, double webThickness, double topFlangeThickness, double bottomFlangeThickness, double topFilletRadius, double bottomFilletRadius, double topEdgeRadius, double bottomEdgeRadius, glm::dmat3 placement = glm::dmat3(1), int numSegments = 8)
	{
		glm::dmat4 placement4 = glm::dmat4(
			glm::dvec4(placement[0], 0.0),  // First column + w=0
			glm::dvec4(placement[1], 0.0),  // Second column + w=0  
		...
		bimGeometry::Curve temp = bimGeometry::GetAsymmetricIShapedCurve(topWidth, bottomWidth, depth, webThickness, topFlangeThickness, bottomFlangeThickness, topFilletRadius, bottomFilletRadius, topEdgeRadius, bottomEdgeRadius, placement4, numSegments);
		IfcCurve c;
		c.points = temp.points;
		return c;
	}

	inline IfcCurve GetUShapedCurve(double depth, double flangeWidth, double webThickness, double flangeThickness, double filletRadius, double edgeRadius, double flangeSlope, glm::dmat3 placement = glm::dmat3(1), int numSegments = 8)
	{
		glm::dmat4 placement4 = glm::dmat4(
			glm::dvec4(placement[0], 0.0),  // First column + w=0
			glm::dvec4(placement[1], 0.0),  // Second column + w=0  
		...
		bimGeometry::Curve temp = bimGeometry::GetUShapedCurve(depth, flangeWidth, webThickness, flangeThickness, filletRadius, edgeRadius, flangeSlope, placement4, numSegments);
		IfcCurve c;
		c.points = temp.points;
		return c;
	}
	...
	inline IfcCurve GetTShapedCurve(double width, double depth, double webThickness, double flangeThickness, bool hasFillet, double filletRadius, double flangeEdgeRadius, double webEdgeRadius, double legSlope, int numSegments = 8, glm::dmat3 placement = glm::dmat3(1))
	{
		glm::dmat4 placement4 = glm::dmat4(
			glm::dvec4(placement[0], 0.0),  // First column + w=0
			glm::dvec4(placement[1], 0.0),  // Second column + w=0  
		...
		bimGeometry::Curve temp = bimGeometry::GetTShapedCurve(width, depth, webThickness, flangeThickness, hasFillet, filletRadius, flangeEdgeRadius, webEdgeRadius, legSlope, placement4, numSegments);
		IfcCurve c;
		c.points = temp.points;
		return c;
	}

	inline IfcCurve GetCShapedCurve(double width, double depth, double girth, double thickness, bool hasFillet, double filletRadius, glm::dmat3 placement = glm::dmat3(1), int numSegments = 8)
	{
		glm::dmat4 placement4 = glm::dmat4(
			glm::dvec4(placement[0], 0.0),  // First column + w=0
			glm::dvec4(placement[1], 0.0),  // Second column + w=0  
		...
		bimGeometry::Curve temp = bimGeometry::GetCShapedCurve(width, depth, girth, thickness, hasFillet, filletRadius, placement4, numSegments);
		IfcCurve c;
		c.points = temp.points;
		return c;
	}

	inline IfcCurve GetZShapedCurve(double depth, double flangeWidth, double webThickness, double flangeThickness, double filletRadius, double edgeRadius, glm::dmat3 placement = glm::dmat3(1), int numSegments = 8)
	{
		glm::dmat4 placement4 = glm::dmat4(
			glm::dvec4(placement[0], 0.0),  // First column + w=0
			glm::dvec4(placement[1], 0.0),  // Second column + w=0  
		...
		bimGeometry::Curve temp = bimGeometry::GetZShapedCurve(depth, flangeWidth, webThickness, flangeThickness, filletRadius, edgeRadius, placement4, numSegments);
		IfcCurve c;
		c.points = temp.points;
		return c;
	}
