...
namespace webifc::parsing
{
    ...
    private:
      ...
      std::unordered_map<uint32_t, std::vector<uint32_t>> _referrers;
      void ParseLines();
      ...
      void AddLineReferences(uint32_t expressID, uint32_t tapeOffset);
      void RemoveLineReferences(uint32_t expressID, uint32_t tapeOffset);
