...
namespace webifc::cache
{
  ...
  public:
    ...
    const ankerl::unordered_dense::map<uint32_t, std::vector<std::pair<uint32_t, uint32_t>>> &GetPresentationLayerStyles() const;
    ...
    ankerl::unordered_dense::map<uint32_t, glm::dvec3> &GetDirectionCache();
  ...
  private:
    ...
    ankerl::unordered_dense::map<uint32_t, std::vector<std::pair<uint32_t, uint32_t>>> _presentationLayerStyles;
    ...
    ankerl::unordered_dense::map<uint32_t, glm::dvec3> _directionCache;
    ...
    ankerl::unordered_dense::map<uint32_t, std::vector<std::pair<uint32_t, uint32_t>>> PopulatePresentationLayerStylesMap();
